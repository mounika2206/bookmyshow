...
const Movie = () => {
  ...
  const settings = {
    ...
    <div className=" my-12 container px-4 lg:ml-20 lg:w-2/3">
     ...
     <p >Bruce Wayne and Diana Prince try to bring 
     the metahumans of Earth together after the death of Clark Kent. 
     Meanwhile, Darkseid sends Steppenwolf to Earth with
      an army to subjugate humans.</p>
     </div>
     <div className="my-8">
     <hr/>
     </div>
